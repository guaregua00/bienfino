...
<h1>Modificar Publicación: <?php echo $publicacion->modelo." ".$publicacion->marca." ".$publicacion->modelo." ".$publicacion->id_ano;?></h1>
<!-- <h3 style="color: #ffad03;">¡Describe tu Vehículo!</h3> -->

<form action="<?php echo base_url(); ?>Cpublicacion/modificarPublicacionUsuario" method="POST" id="form_c" name="form_c">
                  ...
                  <!--<div class="form-group">-->
                    ...
                    <select  class="input-form" name="codigoestado" id="codigoestado" required="">
                      ...
                      foreach ($estados as $value) {?>
                        ...
                        <?php if($publicacion->codigoestado == $value->codigoestado){
                          echo "<option value='".$publicacion->codigoestado."' selected>".ucwords($publicacion->estado)."</option>";}else{ ?>
              ...
              <div class="group-text-field">
                ...
                <div class="form-select bienfino-select">
                      <select  class="input-form" name="codigomunicipio" id="codigomunicipio" required="">
                        ...
                        <?php echo "<option value='".$publicacion->codigomunicipio."' selected>".ucwords($publicacion->municipio)."</option>";?>
                    </select>
              </div>
                <span class="help-block">Seleccione un estado</span>               
                  <!--</div>-->
              </div>
              ...
              <div class="group-text-field">
                ...
                <div class="form-select bienfino-select">
                    <select  class="input-form" name="codigoparroquia" id="codigoparroquia" required="">
                      ...
                      <?php echo "<option value='".$publicacion->codigoparroquia."' selected>".ucwords($publicacion->parroquia)."</option>";?>
                    </select>
              </div>
                <span class="help-block">Seleccione una parroquia</span>               
                </div>
                <!--</div>-->
          </div>
<!--end ubicacion-->
...
<!--detallesubicacion-->
          <div class="flex-col">
            ...
            <div class="flex-row">
                  ...
                  <div class="group-text-field">
                    ...
                    <input type="tel" class="input-form" id="moviluno" name="moviluno" maxlength="11" value="<?php if(isset($publicacion)) echo $publicacion->moviluno;?>" disabled>
                  ...
                  <div class="group-text-field">
                    ...
                    <input type="tel" class="input-form" id="movildos" name="movildos" maxlength="11" value="<?php if(isset($publicacion)) echo $publicacion->movildos;?>" disabled>
          ...
          <div class="flex-col">
            ...
            <div class="group-text-field">
                    ...
                    <textarea class="input-form" rows="10" maxlength="1000" name="comentario" required=""><?php if(isset($publicacion)) echo trim($publicacion->comentario);?></textarea>
...
<div id="detalles_vehiculo">
          ...
          <div class="flex-row">        
            <div class="group-text-field">
                    ...
                    <input type="text" class="input-form" id="motor" name="motor" placeholder="" maxlength="30" value="<?php if(isset($publicacion)) echo $publicacion->motor;?>">
            </div>
            <div class="group-text-field">
                    <label for="motor">Nro Cilindros</label>
                    <input type="text" class="input-form" id="nro_cilindros" name="nro_cilindros" maxlength="2" value="<?php if(isset($publicacion)) echo $publicacion->nro_cilindros;?>" >
            </div>
...
<!--end publicacion-->
          ...
          -->
                <input type="hidden" name="codigo" value="<?php if(isset($publicacion)) echo $publicacion->codigo;?>">
                <input type="hidden" name="id_publicacion" value="<?php if(isset($publicacion)) echo $publicacion->id_publicacion;?>">


          <div class="flex-row">
              <div class="group-text-field">
                <a href="<?php echo base_url();?>misPublicacionesExito" class="btn btn-mini btn-back" id="btn-c-regresar" >Regresar</a> 
              </div>
              <div class="group-text-field">
                  <button type="submit" class="btn btn-info btn-mini" id="btn-c-continuar">Actualizar</button>
              </div>                
          </div>

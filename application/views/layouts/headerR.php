...
<!--     <link href="<?php echo base_url(); ?>asset/fontawesome/css/brands.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url(); ?>asset/css/grid.css" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url(); ?>Bienfino-master/css/grid.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/js/glider/glider.css" />
...
<![endif]-->
    <header>
        <nav class="menu" id="menu">
            ...
            <?php if (isset($resultadodirectorio) and $resultadodirectorio==true) {
                echo '<style>#formhome, #formhome2{visibility: hidden !important;}</style>';
...
<!--                                 <a href="#">Actualizar Publicación</a>
    ...
    <script>
        ...
        function cargarVista(nombreVista){
            window.location.href = nombreVista;
        }
    </script>